...
public class OrderProcessorVerticle extends AbstractVerticle {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(OrderProcessorVerticle.class);
	...
	public void start() throws Exception {
		...
		TopicPartition tp = new TopicPartition().setPartition(0).setTopic("orders");
